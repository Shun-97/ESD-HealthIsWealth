...
try {
    ...
    try {
        ...
        // echo $linkedin_id;
        $link = 'https://www.edamam.com/results/recipe/?recipe=chicken-rice-soup-110880e24455ef15e2de76501fd5d26e/?search=chicken+rice';
        $body = new \stdClass();
        ...
        $body->content->contentEntities[0]->thumbnails[0]->resolvedUrl = "https://www.edamam.com/results/recipe/?recipe=chicken-rice-soup-110880e24455ef15e2de76501fd5d26e/?search=chicken+rice";
